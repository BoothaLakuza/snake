...
public class ArmLogicScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        SetSegments();
        SetNewArmLenghts();
        //if (numberOfSegments > armSegments.Count)
        //{
        //    AddSegments();
        //}
        //else if(numberOfSegments < armSegments.Count)
        //{
    ...
    private float CalculateError()
    {
        ...
        return Vector3.Distance(armSegments[(armSegments.Count - 1)].GetComponent<SegmentScript>().endPoint, targetPoint.position);
    }
